...
<body class="d-flex h-100 text-center text-bg-dark">
  ...
  <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
    ...
    <main class="px-3">
      ...
      // $usuario=$connection->query("DELETE FROM users WHERE id='$id'");
      echo "<div class='alert alert-danger' role='alert'>
        Você realmente gostaria de excluir o usuário $nomeUsuario, $emailUsuario ?
      </div>";
...
";
      ...
      echo sprintf(
        ...
        <tr class='table-dark'>
                    ...
                    <td class='table-dark'>%s</td>
                    <td>
                          <a class='btn btn-light' value='editar' href='editarUser.php?id=" . $idUsuario . "' role='button'>Editar</a>
                          <a class='btn btn-danger' href='./controller/excluirUser.php?id=" . $idUsuario . "' role='button'>Excluir</a>
                      </td>
                   </tr>",
        $idUsuario,
        $nomeUsuario,
      ...
      ?>
      <p class="lead">
        <!-- <button type="submit" name="operacao" value="cadastrar" class="btn btn-light">Cadastrar novo usuário</button> -->
